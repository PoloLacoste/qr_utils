...
class QrUtils 
{
	static const MethodChannel _channel = const MethodChannel('com.aeologic.adhoc.qr_utils');
	...
	// Returns Future<Uint8List> after generating QR Image
	static Future<Uint8List> generateQRBytes(String content) async
	{
		final Uint8List uInt8list =
			await _channel.invokeMethod('generateQR', {"content": content});
		return uInt8list;
